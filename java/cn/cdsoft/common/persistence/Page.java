 ...
 */
package cn.cdsoft.common.persistence;
...
//	private List<Map<String,Object>> mapList = new ArrayList<Map<String,Object>>();
	...
	public Page(HttpServletRequest request, HttpServletResponse response, int defaultPageSize){
		...
		String signLogo = request.getParameter("signLogo");
		if(signLogo==null&&no==null) {
			no="1";
		}
...
//	public Page<Map<String,Object>> setMapList(List<Map<String,Object>> mapList) {

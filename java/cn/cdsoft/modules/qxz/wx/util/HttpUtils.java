...
public class HttpUtils {
	...
	private static String sendPost(String url, Map<String, Object> params, Map<String, Object> headers, boolean isJSON) {
		...
		try {
			...
			// 发送请求参数
//            temp = "{\"phone_numbers\":[\"13950286581\"],\"sign_name\":\"福州川大软件科技\",\"parameters\":[\"1234\", \"3\"],\"template_code\":\"220118\"}";
			out.print(temp);
    ...
    public static String sendPost2(String url, String json, Map<String, Object> headers) {
        PrintWriter out = null;
        BufferedReader in = null;
        String result = "";
        String temp = "";

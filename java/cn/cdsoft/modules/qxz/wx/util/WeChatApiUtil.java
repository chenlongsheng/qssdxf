...
import cn.cdsoft.common.utils.JedisUtils;
import cn.cdsoft.modules.qxz.wx.entry.TextObject;
...
//        String token = WeChatApiUtil.getToken(appId, appSecret);
     ...
     * @return 请求响应内容转换成字符串信息
     */
    public static String httpsRequestToString1(String path, String method, String body) {
        if (path == null || method == null) {
            return null;
        }
    ...
    public static void main(String[] args) throws Exception {
        //媒体文件路径
        String filePath = "D:/project/DEMO/help.jpg";
//        String filePath = "D:/project/DEMO/wechat/WxStudy/web/media/voice/voice.mp3";
//        String filePath = "D:/project/DEMO/wechat/WxStudy/web/media/video/小苹果.mp4";
        //媒体文件类型
        String type = "image";
//        String type = "voice";
//        String type = "video";
        JSONObject uploadResult = uploadMedia(filePath, type);
//        {"media_id":"aTcCbzSmFceUdU-G0VB_cd16-R9qG2fP8x3NCekdYiIr0vFyDjrvLuugBZrUCxLo","created_at":1455520569,"type":"image"}
        //20f_QKF2qYvlIxMQO1Mq5QjCofTtJxds6FVW0LnUtTwGLu5g_jYBS93GPWXeBwtU
